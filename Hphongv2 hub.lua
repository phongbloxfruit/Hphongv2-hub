...
ImageButton.Image = "http://www.roblox.com/asset/?id=98038488082418"
...
local Tabs = {
    ...
    Title = "TIKTOK",
    Description = "phong cày thuê",
    Callback = function()
        setclipboard("https://www.tiktok.com/@hnphong_bloxfruit?_t=ZS-8w0h7CYJWx0&_r=1")
    end
})
